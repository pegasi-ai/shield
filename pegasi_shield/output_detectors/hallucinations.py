...
class ModernBERTGroundednessDetector(Detector):
    ...
    ModernBERT model from KRLabsOrg/lettucedect-base-modernbert-en-v1.
    ...
    def __init__(self, threshold=0.5, model_path="KRLabsOrg/lettucedect-base-modernbert-en-v1"):
        ...
        logger.debug(f"Initialized ModernBERTGroundednessDetector with model {self._model_path}")
