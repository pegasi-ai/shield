from pegasi_shield.core.input_detectors import (
    Anonymize,
    StopInputSubstrings,
    LanguageInput,
    Secrets,
...
from pegasi_shield.core.output_detectors import (
...
from pegasi_shield.core.vault import Vault
...
if __name__ == "__main__":
    ...
    good_patterns = [r"\b(union(\s+all)?|select|insert|update|delete|from|where)\b"]
    bad_patterns = [r"\b(union(\s+all)?|select|insert|update|delete|from|where)\b"]
